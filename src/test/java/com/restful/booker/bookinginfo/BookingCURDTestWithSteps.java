...
public class BookingCURDTestWithSteps extends TestBase {
    ...
    public static String firstname = "Mary" + TestUtils.getRandomValue();
    public static String lastname = "John" + TestUtils.getRandomValue();
    ...
    public void test002() {
        ...
        bookingsDatesData.put("checkin", "2024-02-01");
        bookingsDatesData.put("checkout", "2024-02-08");
